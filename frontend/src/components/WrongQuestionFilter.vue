  ...
  <el-card class="filter-card">
    <el-form :model="filters" inline>
      <el-form-item label="视频">
        <el-select v-model="filters.lesson_id" placeholder="选择视频" clearable @change="$emit('filter-change', filters)">
          <el-option
      ...
      <el-form-item label="知识点">
        <el-select v-model="filters.knowledge_point_id" placeholder="选择知识点" clearable @change="$emit('filter-change', filters)">
          <el-option
