...
describe('资源推荐功能集成测试', () => {
    ...
    test('19.8 推荐历史查询（最近30天，点击率统计）', async () => {
        ...
        const recentRecommendations = recommendationHistory.filter(rec => rec.recommended_at >= thirtyDaysAgo);
...
async function setupTestData() {
    try {
       ...
       VALUES (?, ?, ?, ?, ?)`, ['test_basic_member', 'hash123', '基础会员', 'student', 'active']);
       ...
       VALUES (?, ?, ?, ?, ?)`, ['test_premium_member', 'hash123', '高级会员', 'student', 'active']);
...
//# sourceMappingURL=resource-recommendation.test.js.map