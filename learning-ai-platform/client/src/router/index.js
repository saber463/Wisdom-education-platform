...
// 代码生成器
// const CodeGeneratorFixed = () => import('@/views/learning/CodeGeneratorFixed.vue')
// const CodeGeneratorFull = () => import('@/views/learning/CodeGeneratorFull.vue')
...
const routes = [
  {
    ...
    children: [
      ...
      // 代码生成器
      // {
      //   path: '/code-generator/fixed',
      //   name: 'CodeGeneratorFixed',
      //   component: CodeGeneratorFixed,
      //   meta: { requiresAuth: false }
      // },
      // {
      //   path: '/code-generator/full',
      //   name: 'CodeGeneratorFull',
      //   component: CodeGeneratorFull,
      //   meta: { requiresAuth: false }
      // },
      // 用户中心
      {
