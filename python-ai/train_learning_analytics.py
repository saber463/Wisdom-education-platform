...
# -*- coding: utf-8 -*-
"""
BERT学情分析模型训练脚本（CPU极致优化版）
功能：基于真实教育数据训练BERT模型，用于学生学情分析
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('train_learning_analytics.log'),
...
# 资源限制阈值
CPU_LIMIT = 70.0  # CPU使用率上限
MEMORY_LIMIT = 60.0  # 内存使用率上限

# ====================== 训练配置 ======================
MODEL_NAME = "bert-base-chinese"
OUTPUT_DIR = "./models/learning_analytics"
PROCESSED_DATA_DIR = "./data/processed/learning_analytics_dataset"
...
def main():
    logger.info("="*60)
    logger.info("开始训练BERT学情分析模型（CPU优化版）")
    logger.info("="*60)
    ...
    training_args = TrainingArguments(
        ...
        weight_decay=0.01,
        logging_dir='./logs/learning_analytics',
        logging_steps=50,
        eval_strategy="epoch",
        save_strategy="epoch",
        ...
        save_total_limit=2,
        dataloader_num_workers=0,  # CPU模式下禁用多进程
