...
// 获取分类和知识点数据
const mockArticles = [
  { id: 'mk1', title: 'JavaScript闭包原理与应用场景', categoryId: 'js', categoryName: 'JavaScript', summary: '深入理解闭包的执行上下文、作用域链，以及在模块化、防抖节流中的经典应用', level: 2, keywords: ['闭包', '作用域', '执行上下文'], createdAt: new Date().toISOString(), cover: 'https://picsum.photos/seed/kb1/80/60' },
  { id: 'mk2', title: 'Vue3响应式系统：Proxy vs Object.defineProperty', categoryId: 'vue', categoryName: 'Vue3', summary: 'Vue3使用Proxy替代Object.defineProperty的原因，track/trigger依赖收集机制详解', level: 3, keywords: ['Proxy', '响应式', 'Vue3'], createdAt: new Date().toISOString(), cover: 'https://picsum.photos/seed/kb2/80/60' },
  { id: 'mk3', title: 'Python生成器与协程：yield的深度解析', categoryId: 'py', categoryName: 'Python', summary: 'generator/yield/send机制，以及async/await的协程模型在异步IO中的应用', level: 3, keywords: ['生成器', 'yield', '协程'], createdAt: new Date().toISOString(), cover: 'https://picsum.photos/seed/kb3/80/60' },
  { id: 'mk4', title: 'TCP三次握手与四次挥手全解析', categoryId: 'net', categoryName: '计算机网络', summary: '从状态机角度深入理解TCP连接建立与断开过程，TIME_WAIT和CLOSE_WAIT常见问题', level: 2, keywords: ['TCP', '三次握手', '网络'], createdAt: new Date().toISOString(), cover: 'https://picsum.photos/seed/kb4/80/60' },
  { id: 'mk5', title: 'MySQL索引优化：B+树与查询计划', categoryId: 'db', categoryName: '数据库', summary: '聚簇索引、覆盖索引、联合索引最左前缀原则，EXPLAIN分析查询性能瓶颈', level: 3, keywords: ['MySQL', '索引', 'B+树'], createdAt: new Date().toISOString(), cover: 'https://picsum.photos/seed/kb5/80/60' },
  { id: 'mk6', title: 'React Hooks原理：useState与useEffect源码解析', categoryId: 'react', categoryName: 'React', summary: '从Fiber架构理解Hooks链表结构，useState更新队列和useEffect的调度机制', level: 4, keywords: ['React', 'Hooks', 'Fiber'], createdAt: new Date().toISOString(), cover: 'https://picsum.photos/seed/kb6/80/60' },
  { id: 'mk7', title: 'Docker容器原理：namespace与cgroup', categoryId: 'devops', categoryName: 'DevOps', summary: 'Linux namespace资源隔离，cgroup资源限制，以及容器镜像分层存储机制', level: 3, keywords: ['Docker', 'namespace', 'cgroup'], createdAt: new Date().toISOString(), cover: 'https://picsum.photos/seed/kb7/80/60' },
  { id: 'mk8', title: '动态规划：从记忆化搜索到状态转移方程', categoryId: 'algo', categoryName: '算法', summary: '背包问题、最长公共子序列、编辑距离等经典DP问题的状态定义与转移分析', level: 3, keywords: ['动态规划', 'DP', '算法'], createdAt: new Date().toISOString(), cover: 'https://picsum.photos/seed/kb8/80/60' },
  { id: 'mk9', title: 'Java并发编程：volatile与happens-before', categoryId: 'java', categoryName: 'Java', summary: 'JMM内存模型，volatile的内存屏障实现，synchronized锁升级与AQS框架原理', level: 4, keywords: ['Java', 'volatile', 'JMM'], createdAt: new Date().toISOString(), cover: 'https://picsum.photos/seed/kb9/80/60' },
  { id: 'mk10', title: 'HTTP/2与HTTP/3核心特性对比', categoryId: 'net', categoryName: '计算机网络', summary: '多路复用、头部压缩、服务端推送，QUIC协议解决HTTP/2队头阻塞问题', level: 2, keywords: ['HTTP/2', 'HTTP/3', 'QUIC'], createdAt: new Date().toISOString(), cover: 'https://picsum.photos/seed/kb10/80/60' },
];
