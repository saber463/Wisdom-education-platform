<template>
  <div v-if="learningPath" class="max-w-4xl mx-auto bg-white rounded-xl shadow-md p-6">
    <div class="mb-6 flex items-center justify-between">
      <h3 class="text-xl font-bold text-primary mb-2">学习目标：{{ learningPath.goal }}</h3>
      <span
    ...
    <div class="mt-4 p-4 bg-blue-50 rounded-lg">
      <h4 class="font-medium text-dark mb-2">路径总结</h4>
    ...
    <div class="mt-8">
      <h3 class="text-xl font-bold text-dark mb-4">每日学习计划</h3>

      <div v-if="learningPath.isStreaming" class="text-center py-8 text-gray-500">
