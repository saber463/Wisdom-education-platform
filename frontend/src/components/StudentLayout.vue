    ...
    <aside class="layout-sidebar" :class="{ collapsed: sidebarCollapsed }">
      ...
      <div class="layout-logo">
        ...
        <div v-if="!sidebarCollapsed" class="logo-text">
          ...
          <div class="logo-sub">STUDENT · V2.0</div>
        </div>
      </div>
...
import {
  ...
  Reading, DataLine, Cpu, Notebook, ChatSquare
...
const navItems = [
  ...
  { path: '/student/results',         label: '批改结果',   icon: Finished     },
  { path: '/student/learning-path',   label: '学习路径',   icon: DataLine     },
  { path: '/student/virtual-partner', label: 'AI学伴',    icon: Cpu          },
  { path: '/student/wrong-book',      label: '错题本',     icon: Notebook     },
  { path: '/student/code-editor',     label: '代码编辑',   icon: Cpu          },
  { path: '/student/community',       label: '学习社区',   icon: ChatSquare   },
  { path: '/student/recommendations', label: '练习推荐',   icon: Star         },
  { path: '/student/qa',              label: 'AI答疑',    icon: ChatDotRound  },
  { path: '/student/speech',          label: '口语评测',   icon: Microphone   },
]
...
.logo-icon {
  ...
  font-size: 18px;
  box-shadow: 0 0 16px rgba(0, 255, 148, 0.35);
}
...
.nav-item.active .nav-icon-wrap { color: #00FF94; }
...
.topbar-left :deep(.el-breadcrumb__item .el-breadcrumb__inner) {
  color: #505050;
  font-size: 13px;
}
...
.topbar-left :deep(.el-breadcrumb__separator) { color: #404040; }
...
.user-avatar {
  border: 2px solid rgba(0,255,148,0.3) !important;
...
@media (max-width: 1024px) {
  ...
  .logo-text, .nav-label, .nav-badge { display: none; }
