      ...
      <div class="course-detail" v-loading="loading">
        <div v-if="course" class="detail-content">
          ...
          <el-card class="branches-section">
            ...
            <el-tabs v-model="activeBranchId" @tab-change="loadLessons">
              <el-tab-pane
                  ...
                  >
                    <div class="lesson-info">
                      ...
                      <div class="lesson-meta">
                        ...
                        <el-tag v-if="lesson.is_free" type="success" size="small">免费试看</el-tag>
                      </div>
                    </div>
                    <el-button
                      v-if="isPurchased"
                    ...
                    <el-button v-else disabled>需购买</el-button>
                  </div>
                </div>
              </el-tab-pane>
            </el-tabs>
