 ...
 * 获取当前Python镜像源
 */
function getCurrentPythonMirror() {
 ...
 * 设置Python镜像源
 */
function setPythonMirror(mirrorUrl) {
 ...
 * 设置npm镜像源
 */
function setNpmMirror(mirrorUrl) {
 ...
 * 切换Python镜像源
 */
export function switchPythonMirror() {
    log('=== 开始切换Python镜像源 ===');
 ...
 * 切换npm镜像源
 */
export function switchNpmMirror() {
    log('=== 开始切换npm镜像源 ===');
 ...
 * 自动切换所有镜像源
 */
export function autoSwitchMirrors() {
    log('=== 开始自动切换镜像源 ===');
...
//# sourceMappingURL=mirror-switcher.js.map